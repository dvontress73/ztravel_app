CLASS zcl_generate_travel_data_dvt DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_dvt IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_dvt.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_dvt.

*   insert the new table entries
    INSERT ztravel_dvt FROM TABLE @itab.
